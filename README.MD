...
```
cscript ospp.vbs /sethst:kms.cnbrony.com
```
...
```
cscript "C:\Program Files (x86)\Microsoft Office\Office16\OSPP.VBS" /sethst:kms.cnbrony.com
```
